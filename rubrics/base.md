...
*Did the candidate make deliberate choices, or accept defaults and move on?*
...
### 1.3 Open Question Response (0–10)
...
**What to look for:**
- Is the open question addressed in the README?
...
*Is the submission internally consistent? Do the pieces fit together as a coherent whole?*
...
**Task-specific implied edge cases:**
[Populated when the task is generated — see task file]
...
*Is there evidence that a human made deliberate decisions throughout this submission?*
...
**What it measures:** Whether the README was written by someone who built this specific submission, or could have been generated without reading the task or writing the code.

The signal is specificity and traceability. Every section of the README should be traceable to a specific decision in the code. If a section could be lifted from this README and placed in a different submission without modification, it scores near zero.
...
**Scoring:**
- 10 — README is traceable to this specific submission at every section. Every claim is verifiable in the code.
...
- 0 — Missing, empty, or entirely non-specific
...
These apply to every role. The role-specific patch adds additional hard fails on top of these.
...

{
  ...
  "overall": average of the three pillar scores as a percentage (0-100),
  "summary": "Three to five sentences. Direct. No diplomatic softening. State what the submission reveals about the engineer behind it — not just what works and what does not. Reference specific files, decisions, or patterns.",
  ...
  "inline_comments": [
    {
      ...
      "note": "Specific observation about this exact line or pattern."
    }
  ],
...
Verdict rules:
- APPROVE only if: no hard fails, overall ≥ 65, no pillar score below 60
- REQUEST_CHANGES for anything else

Hire signal rules:
- strong: overall ≥ 85, no hard fails
- moderate: overall ≥ 65, no hard fails
- weak: overall ≥ 50, may have minor issues
- no: overall < 50 or any hard fail triggered
